...
```
The initial sample of complete data consisted of `r report::report_participants(df |> dplyr::select(Age, Gender, Education), age="Age", gender="Gender", education="Education")`, for a total trial number of `r nrow(df_dog)+nrow(df_simpleRT)`.
