...
const ConsentForm = {
    ...
    survey_json: function () {
        ...
        text +=
            ...
            `The whole experiment will take you <b style='color:#FF5722;'>do we want to include an approx duration if also asking them to estimate?</b> to complete. Please make you sure that you are <b>attentive and in a quiet environment</b>, and that you have time to complete it in one go.</p>` +
